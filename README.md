...
| ------- | ------- | -------- | --------- | ----- | --------------- |
|[01-two-sums](go/app/exercises/01-two-sums) | 1.358 | 16 B/op | 1 allocs/op | 11.16 ns/op | 3/3 :white_check_mark:|
|[02-time-to-buy-stocks](go/app/exercises/02-time-to-buy-stocks) | 1.349 | 0 B/op | 0 allocs/op | 5.075 ns/op | 2/2 :white_check_mark:|
|[03-contains-duplicates](go/app/exercises/03-contains-duplicates) | 1.361 | 0 B/op | 0 allocs/op | 34.00 ns/op | 3/3 :white_check_mark:|
|[04-product-of-array-except-self](go/app/exercises/04-product-of-array-except-self) | 1.363 | 32 B/op | 1 allocs/op | 17.27 ns/op | 2/2 :white_check_mark:|
|[05-maximum-subarray](go/app/exercises/05-maximum-subarray) | 1.356 | 0 B/op | 0 allocs/op | 5.826 ns/op | 3/3 :white_check_mark:|
|[06-maximum-product-subarray](go/app/exercises/06-maximum-product-subarray) | 1.342 | 0 B/op | 0 allocs/op | 4.468 ns/op | 2/2 :white_check_mark:|
|[07-min-rotated-sorted-array](go/app/exercises/07-min-rotated-sorted-array) | 1.340 | 0 B/op | 0 allocs/op | 4.499 ns/op | 3/3 :white_check_mark:|
|[08-search-rotated-array](go/app/exercises/08-search-rotated-array) | 1.330 | 0 B/op | 0 allocs/op | 3.603 ns/op | 4/4 :white_check_mark:|
|[09-3sum](go/app/exercises/09-3sum) | 1.262 | 120 B/op | 4 allocs/op | 167.0 ns/op | 3/3 :white_check_mark:|
|[10-container-with-most-water](go/app/exercises/10-container-with-most-water) | 1.355 | 0 B/op | 0 allocs/op | 8.696 ns/op | 5/5 :white_check_mark:|
|[11-sum-of-two-integers](go/app/exercises/11-sum-of-two-integers) | 1.290 | 0 B/op | 0 allocs/op | 1.975 ns/op | 3/3 :white_check_mark:|
|[12-number-of-1-bits](go/app/exercises/12-number-of-1-bits) | 1.366 | 4 B/op | 1 allocs/op | 19.42 ns/op | 3/3 :white_check_mark:|
|[27-clone-graph](go/app/exercises/27-clone-graph) | 1.362 | 1056 B/op | 32 allocs/op | 849.7 ns/op | 3/3 :white_check_mark:|
|[35-insert-interval](go/app/exercises/35-insert-interval) | 1.372 | 168 B/op | 3 allocs/op | 81.75 ns/op | 2/2 :white_check_mark:|
|[36-merge-interval](go/app/exercises/36-merge-interval) | 1.373 | 168 B/op | 3 allocs/op | 81.59 ns/op | 2/2 :white_check_mark:|
|[50-length-of-longest-substring](go/app/exercises/50-length-of-longest-substring) | 1.350 | 0 B/op | 0 allocs/op | 32.15 ns/op | 3/3 :white_check_mark:|
